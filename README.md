...
**Campus Cat Mate**는 파편화된 캠퍼스 고양이 정보를 통합하여 </br>
실시간 위치 예측, 예상 동선 분석, 그리고 체계적인 건강 관리를 제공하는 **생태 기반 지능형 시스템**입니다.
...
본 프로젝트는 Vercel을 통해 배포되었으나, 2026.06.28 기준으로 배포가 종료되었습니다.
